...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "   kick(i32 id, string name)")
  fmt.Fprintln(os.Stderr, "  void put(Art na)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := la.NewKickArtClientFactory(trans, protocolFactory)
  ...
  case "kick":
    ...
    value1 := argvalue1
    fmt.Print(client.Kick(value0, value1))
    fmt.Print("\n")
    break
  case "put":
    if flag.NArg() - 1 != 1 {
